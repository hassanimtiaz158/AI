...
predtrain_data=ans[0,0]+(ans[1,0]*x)+(ans[2,0]*x**2)+(ans[3,0]*x**3)+(ans[4,0]*x**4)+(ans[5,0]*x**5)
...
predtest_data=ans[0,0]+(ans[1,0]*x1)+(ans[2,0]*x1**2)+(ans[3,0]*x1**3)+(ans[4,0]*x1**4)+(ans[5,0]*x1**5)
...
#Result: The 5th-degree polynomial regression model perfectly fits the training data but performs poorly on the test data, showing severe overfitting.